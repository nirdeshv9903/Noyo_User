...
class BookingUsecase {
  ...
  Future<Either<Failure, DestinationChangeModel>> changeDestinationApi(
      ...
      required List<AddressModel> stops})async{
        return _bookingRepository.changeDestinationApi(requestId: requestId, dropLat: dropLat, dropLng: dropLng, dropAddress: dropAddress, duration: duration, distance: distance, polyLine: polyLine, stops: stops);
      }
}
