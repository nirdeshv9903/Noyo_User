...
AddTipResponseModel addTipResponseModelFromJson(String str) => AddTipResponseModel.fromJson(json.decode(str));

String addTipResponseModelToJson(AddTipResponseModel data) => json.encode(data.toJson());
...
class AddTipResponseModel {
    ...
    factory AddTipResponseModel.fromJson(Map<String, dynamic> json) => AddTipResponseModel(
...
class AddTipResponseData {
  ...
  String? additionalChargesReason;
    ...
    factory AddTipResponseData.fromJson(Map<String, dynamic> json) => AddTipResponseData(
        id: json["id"],
        ...
        adminCommisionFromDriver: json["admin_commision_from_driver"]?.toDouble(),
