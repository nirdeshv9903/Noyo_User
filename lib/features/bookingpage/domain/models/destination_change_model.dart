...
DestinationChangeModel destinationChangeModelFromJson(String str) => DestinationChangeModel.fromJson(json.decode(str));

String destinationChangeModelToJson(DestinationChangeModel data) => json.encode(data.toJson());
...
class DestinationChangeModel {
    ...
    factory DestinationChangeModel.fromJson(Map<String, dynamic> json) => DestinationChangeModel(
...
class DestinationChangeModelData {
  ...
  String parcelType;
    ...
    factory DestinationChangeModelData.fromJson(Map<String, dynamic> json) => DestinationChangeModelData(
        id: json["id"] ?? '',
...
class RequestUserDetail {
    ...
    factory RequestUserDetail.fromJson(Map<String, dynamic> json) => RequestUserDetail(
...
class UserDetailData {
    ...
    factory UserDetailData.fromJson(Map<String, dynamic> json) => UserDetailData(
        ...
        showWalletMoneyTransferFeatureOnMobileApp: json["show_wallet_money_transfer_feature_on_mobile_app"],
        showBankInfoFeatureOnMobileApp: json["show_bank_info_feature_on_mobile_app"],
        ...
        showTaxiOutstationRideFeature: json["show_taxi_outstation_ride_feature"],
        showDeliveryOutstationRideFeature: json["show_delivery_outstation_ride_feature"],
        ...
        userCanMakeARideAfterXMiniutes: json["user_can_make_a_ride_after_x_miniutes"],
        ...
        enableLuggagePreferenceForUser: json["enable_luggage_preference_for_user"],
        ...
        enableMapAppearanceChangeOnMobileApp: json["enable_map_appearance_change_on_mobile_app"],
    ...
    Map<String, dynamic> toJson() => {
        ...
        "show_wallet_money_transfer_feature_on_mobile_app": showWalletMoneyTransferFeatureOnMobileApp,
        ...
        "show_delivery_outstation_ride_feature": showDeliveryOutstationRideFeature,
        ...
        "maximum_time_for_find_drivers_for_regular_ride": maximumTimeForFindDriversForRegularRide,
        "maximum_time_for_find_drivers_for_bitting_ride": maximumTimeForFindDriversForBittingRide,
        ...
        "enable_map_appearance_change_on_mobile_app": enableMapAppearanceChangeOnMobileApp,
