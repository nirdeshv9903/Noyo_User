                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        MyText(
                                            text:
                                                '${eta.currency} ${!context.read<BookingBloc>().isRentalRide 
                                                ? eta.hasDiscount ? eta.discountTotal : eta.total.toStringAsFixed(1) 
                                                : eta.hasDiscount ? eta.discountedTotel :eta.fareAmount}',
                                            textStyle: Theme.of(context)
                                                .textTheme
                                                .bodyMedium)
                                      ],
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          if((arg.title == 'Send Parcel')||(arg.title == 'Receive Parcel' && arg.stopAddressList.length == 1))
                                          InkWell(
                                            onTap: () {
                                              if (context
                                                          .read<BookingBloc>()
                                                          .transportType ==
                                                      'delivery' &&
                                                  arg.title == 'Send Parcel') {
                                                context
                                                    .read<BookingBloc>()
                                                    .showPaymentChange = true;
                                              } else {
                                                context.read<BookingBloc>().showPaymentChange = false;
                                          ...
                                          if (arg.stopAddressList.length == 1 || (arg.title == 'Receive Parcel' && arg.stopAddressList.length > 1))
                                            InkWell(
                                              onTap: () {
                                                if (context
                                                            .read<BookingBloc>()
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            mainAxisAlignment:
                                                MainAxisAlignment.start,
                                            children: [
                                              Icon(context.read<BookingBloc>().isSavedCardChoose
