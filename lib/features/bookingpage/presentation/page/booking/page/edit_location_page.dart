          ...
          if (state is BookingInitialState) {
            ...
            Navigator.pushNamed(context, ConfirmLocationPage.routeName,
                    arguments: ConfirmLocationPageArguments(
                        ...
                        isPickupEdit: false,
                        isEditAddress: true,
                        isOutstationRide: widget.arg.requestData.isOutStation == '1',
                        mapType: widget.arg.mapType,
                        latlng: LatLng(bookingBloc.dropAddressList[bookingBloc.choosenAddressIndex].lat,bookingBloc.dropAddressList[bookingBloc.choosenAddressIndex].lng),
                      ...
                      builder: (_) {
                        return BlocProvider.value(
                          ...
                          child: DeliveryInstructions(
                            ...
                            address: address,
                            isReceiveParcel:
                                widget.arg.requestData.parcelType == 'Receive Parcel',
            ...
            Navigator.pop(context,EditLocation(requestData: state.requestData, dropAddressList: state.dropAddressList));
          } 
        },
          ...
          builder: (context, state) {
            ...
            return Directionality(
              ...
              child: Scaffold(
                ...
                bottomNavigationBar: bottomConfirmationWidget(size,bookingBloc),
              ),
            );
          },
        ),
            ...
            Positioned(
              ...
              child: InkWell(
                onTap: () {
                  context
                      .read<BookingBloc>()
                      .add(BookingLocateMeEvent(mapType: widget.arg.mapType,controller: (widget.arg.mapType == 'google_map')
          ...
          child: Column(
            ...
            children: [
              ...
              CustomButton(
                ...
                width: size.width,
                textSize:
                    bookingBloc.languageCode == 'fr' ? 14 : null,
                onTap: () {
          ...
          Theme(
            ...
            child: ReorderableListView(
              ...
              children: List.generate(
                ...
                (index) {
                  TextEditingController controller = bookingBloc.addressTextControllerList
                      .elementAt(index);
                  return Padding(
                    key: Key('$index'),
                            ...
                            ? InkWell(
                                onTap: () {
                                  ...
                                  bookingBloc.add(PolylineEvent(
                                    pickLat: double.parse(bookingBloc.requestData!.pickLat),
                                    pickLng: double.parse(bookingBloc.requestData!.pickLng),
                                    dropLat: bookingBloc.dropAddressList.last.lat,
                                    dropLng: bookingBloc.dropAddressList.last.lng,
                                    stops: (bookingBloc.dropAddressList.length > 1)
                                        ? bookingBloc.dropAddressList
                                        : [],
                                    pickAddress: bookingBloc.requestData!.pickAddress,
                                    dropAddress: bookingBloc.dropAddressList.last.address,
                                    isDropChanged: true,
                                  ));
