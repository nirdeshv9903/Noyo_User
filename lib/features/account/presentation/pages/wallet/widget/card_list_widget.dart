                                  ...
                                  children: [                                    
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        (card.cardType.toLowerCase().toString().contains('visa'))
                                        ? Image.asset(AppImages.visa,height: size.width * 0.1,
                                          width: size.width * 0.2,) : (card.cardType.toLowerCase().toString().contains('eftpos'))
                                        ? Image.asset(AppImages.eftpos,height: size.width * 0.1,
                                          width: size.width * 0.2,) : (card.cardType.toLowerCase().toString().contains('american'))
                                        ? Image.asset(AppImages.americanExpress,height: size.width * 0.1,
                                          width: size.width * 0.2,) :(card.cardType.toLowerCase().toString().contains('jcb'))
                                        ? Image.asset(AppImages.jcb,height: size.width * 0.1,
                                          width: size.width * 0.2,) :(card.cardType.toLowerCase().toString().contains('discover || dinners'))
                                        ? Image.asset(AppImages.discover,height: size.width * 0.1,
                                          width: size.width * 0.2,) 
                                          : Image.asset(AppImages.master,height:size.width *0.1,
                                          width:size.width *0.2),
                                      ],
                                    ),
                                    SizedBox(height: size.width * 0.05),
